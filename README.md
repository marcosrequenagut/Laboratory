...
Crear un proyecto: Si el proyecto no existe, se crea un nuevo proyecto con un tiempo inicial de 0.
Obtener todos los proyectos: Muestra todos los proyectos y su tiempo asociado.
Registrar tiempo: Permite agregar tiempo a un proyecto existente.
Eliminar un proyecto: Borra un proyecto de la base de datos.
Snapshot: (Futuro) Funcionalidad para crear un snapshot de un proyecto.
